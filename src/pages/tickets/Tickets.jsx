    ...
    <div>
      ...
      <div className="p-4">
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <br />
                  <span className="text-[10px] text-gray-500">60 months</span>
                </div>
              </div>
              {expanded === 0 ? (
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <br />
                  <span className="text-[10px] text-gray-500">54 months</span>
                </div>
              </div>
              {expanded === 1 ? (
        ...
        <div className=" flex justify-end mt-36">
          <img src={plusVector} alt="" className="bg-[#8AB53E] p-3 rounded-full shadow-xl" />
        </div>
      </div>
      <FooterNavigation />
    </div>
